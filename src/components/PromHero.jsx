        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-16 pt-20 text-center lg:pt-32">
          <div className="">
            ...
            <p className="mt-6 text-lg text-gray-600">
              {'Finally, legal help most people can afford. North Carolina family law firm King @ Law provides apps for uncontested divorces, trial, and everything in-between for North Carolina separations. Start for free and pay just $199 a month for full access with attorney support.'}
            </p>
