    ...
    >
      <div className="max-w-lg mx-auto mb-10 bg-white rounded-xl shadow-md overflow-hidden md:max-w-5xl cursor-pointer">
        <div className="flex flex-col md:flex-row">
          ...
          <div className="py-8 px-6 mb-10 md:p-8">
            <div className="uppercase block mt-1 mb-10 text-3xl leading-tight font-medium text-black">About <span className='text-[#ff551d]'>Our</span> Firm</div>
