...
import { JoinTheBetaListGooglePlayButton } from './common/Buttons/JoinTheBetaListGooglePlayButton'
...
export function AppStoreLink({ color = 'black' }) {
  ...
  if (userOS.includes('apple')) {
    ...
    return (
      ...
      >
        <svg style={{ backgroundColor: 'black', borderRadius: '10px' }} viewBox="0 0 120 40" aria-hidden="true" className="h-10">
          <path
            fill="currentColor"
    ...
    return (
      <div>
        <JoinTheBetaListGooglePlayButton />
        ...
        {/* <Image src={myImage} alt='myImage' style={{height: '2.45rem'}} className="w-full h-auto object-contain my-auto"
          /> */}
      </div>
    )
  }
