...
function Plan({
  ...
  return (
    <section
      className={clsx(
        'flex flex-col rounded-3xl py-1 px-6 mx-6',
  ...
  return (
    ...
    >
      <Container>
        ...
        <div className="-mx-4 mt-16 grid max-w-2xl grid-cols-1 gap-y-5 sm:mx-auto lg:-mx-8 lg:max-w-none lg:grid-cols-3 xl:mx-0 xl:gap-x-8">
          <Plan
            name="Self-Service"
            price="$199/mo"
