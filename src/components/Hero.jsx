        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            ...
            <p className="mt-0 text-lg text-gray-600 mt-3">
              {'What does it mean to be a modern law firm? Efficiency that reduces prices 30-50%. Zoom meetings you can schedule online at your convenience. An app that keeps you up-to-date. Can\'t afford a lawyer? Use our self-service apps starting at just $89/mo.'}
            </p>
