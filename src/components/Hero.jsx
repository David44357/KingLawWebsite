        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            ...
            <p className="mt-0 text-lg text-gray-600 mt-3">
              {'Other law firms focus on serving the wealthy with hourly-rate contracts for ulimited budgets. At King @ Law, we think legal services should be accessible to everyone, not just the wealthy. That\'s why we\'ve cut the fat from a bloated approach to racking up billable hours. Still can\'t afford our flat-fees or payment plans? We offer more affordable do-it-yourself apps to help you represent youself competently.'}
            </p>
