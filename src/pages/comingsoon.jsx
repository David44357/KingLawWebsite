                ...
                <Container>
                    ...
                    <div className="row justify-content-center">
                        <div className="col-md-10 main-title">
                            <h3 className="text-xl font-medium text-gray-900">An iPhone and Android app is coming soon. For now, you can access our customer app from https://apps.kinglawnc.com. Give it a bit to load if you are accessing it on a mobile network.</h3>
                        </div>
                    </div>
