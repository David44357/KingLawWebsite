...
<p className="pb-10 pt-1 mt-6 text-md text-gray-600 my-3">The King @ Law app stores all information and files you provide to it, either in a database with Firebase, or in Google Drive. This may include your login information, financial records, addresses, contacts, progress in the apps, and information about your divorce. The app only contains information you provide to it. If you would like us to delete all or some of the information and records the app has stored about you for security purposes, please contact David@kinglawnc.com from the email address associated with your account.
</p>
                </Container>
            </main>
            <Footer />
