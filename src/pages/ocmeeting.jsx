...
export default function MyApp() {
  ...
  const ListPoints = [
    {
      Title: 'ZOOM',
      Description:
        'Zoom allows us to share files, use chat, or share screens. Being on camera is not necesary.',
      Icon: MicIcon,
    },
    {
      Title: 'PHONE',
      Description:
        'Feel free to call me instead or schedule a meeting manually over email if preferred.',
      Icon: PhoneIcon,
    },
  ]
  ...
  return (
    <>
      ...
      <Header />
    <div>
      <HeroBanner title="OPPOSING COUNSEL" />
            ...
            <div className="px-5 py-8 md:p-8">
              <div className="max-w-md">
                <h2 className="block text-3xl font-medium uppercase leading-tight text-black">
                    SCHEDULE <span className="text-[#ff551d]">MEETING</span>
                </h2>
                <p className="my-3 text-sm font-normal text-gray-500">
                Please use the below app to schedule a Zoom meeting with attorney King. A few notes:
                </p>
