            ...
            <div className="px-5 py-8 md:p-8">
              <div className="max-w-md">
                <h2 className="block text-3xl font-medium uppercase leading-tight text-black">
                  GET A <span className="text-[#ff551d]">CONSULTATION</span>
                </h2>
                <p className="my-3 text-sm font-normal text-gray-500">
                  King @ Law offers attorney consultations over Zoom for $125
                  for every 30-minutes. To make the most of your consultation:
                </p>
